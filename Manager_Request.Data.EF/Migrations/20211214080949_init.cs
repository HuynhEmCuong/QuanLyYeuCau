        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudenId = table.Column<string>(maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskLists_AppUsers_ModifyBy",
                        column: x => x.ModifyBy,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskLists_AppUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskLists_RequestTypes_RequestId",
                        column: x => x.RequestId,
                        principalTable: "RequestTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskLists_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskLists_ModifyBy",
                table: "TaskLists",
                column: "ModifyBy");

            migrationBuilder.CreateIndex(
                name: "IX_TaskLists_ReceiverId",
                table: "TaskLists",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskLists_RequestId",
                table: "TaskLists",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskLists_StudentId",
                table: "TaskLists",
                column: "StudentId");
        }
